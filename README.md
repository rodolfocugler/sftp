...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/atmoz/sftp/build?logo=github) ![GitHub stars](https://img.shields.io/github/stars/rodolfocugler/sftp?logo=github) ![Docker Stars](https://img.shields.io/docker/stars/rodolfocugler/sftp?label=stars&logo=docker) ![Docker Pulls](https://img.shields.io/docker/pulls/rodolfocugler/sftp?label=pulls&logo=docker)

![OpenSSH logo](https://raw.githubusercontent.com/rodolfocugler/sftp/master/openssh.png "Powered by OpenSSH")

## This code is a fork of [atmoz/sftp](https://github.com/atmoz/sftp)
...
```
docker run -p 22:22 -d rodolfocugler/sftp:debian foo:pass:::upload
```
...
docker run \
    ...
    -p 2222:22 -d rodolfocugler/sftp:debian \
    foo:pass:1001
```
